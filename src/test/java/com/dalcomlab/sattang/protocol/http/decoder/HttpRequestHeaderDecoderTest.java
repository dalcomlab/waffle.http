...
public class HttpRequestHeaderDecoderTest {
    @Test
    public void testBasic() throws Exception {
        ...
        HttpRequestHeaderDecoder decoder = new HttpRequestHeaderDecoder();
    ...
    public void testException_RequestLineBytes_Exceed_Limit() throws Exception {
        ...
        HttpRequestHeaderDecoder decoder = new HttpRequestHeaderDecoder(maxRequestLineBytes, maxHeaderBytes, maxHeaderCount);
        HttpRequest request = new DefaultHttpRequest(null);
        try {
            decoder.listen(request);
            decoder.decode(wrap(httpRequest.getBytes()));
