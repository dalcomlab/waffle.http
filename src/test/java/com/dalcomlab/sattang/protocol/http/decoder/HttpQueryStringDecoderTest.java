...
public class HttpQueryStringDecoderTest {

    @Test
    public void testBasic() {
        String data = "a=a&b=b&c=c&d=d";
        Map<String, List<String>> parameters = new HashMap<>();
        HttpQueryStringDecoder decoder = new HttpQueryStringDecoder();
        try {
            decoder.listen(parameters);
            decoder.decode(ByteBuffer.wrap(data.getBytes()));
            decoder.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testBasicWithSpace() {
        String data = "a%20=%20a%20&%20b%20=%20b%20&%20c%20=%20c%20&%20d%20=%20d";
        Map<String, List<String>> parameters = new HashMap<>();
        HttpQueryStringDecoder decoder = new HttpQueryStringDecoder();
        try {
            decoder.listen(parameters);
...
//        Map<String, List<String>> parameters = new HashMap<>();
//        HttpEncodedFormParser parser = new HttpEncodedFormParser(parameters);
//        try {
