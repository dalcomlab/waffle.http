...
public class HttpParameterParser {
     ...
     * @param decoder
     */
    public HttpParameterParser(Function<String, String> decoder) {
     ...
     * @param valueDecoder
     */
    public HttpParameterParser(Function<String, String> nameDecoder, Function<String, String> valueDecoder) {
     ...
     * @return
     */
    public Map<String, String> parse(String text, char separator) {
        char[] array = text.toCharArray();
        return parse(array, 0, array.length, separator);
    }
     ...
     * @return
     */
    public Map<String, String> parse(final char[] text, int offset, int length, char separator) {
        ...
        parse(listener, text, offset, length, separator);
        return parameters;
    }
    ...
    public Map<String, List<String>> parseMultipleValue(String text, char separator) {
        ...
        char[] array = text.toCharArray();
        parse(listener, array, 0, array.length, separator);
        return parameters;
    }
     ...
     * @param separator
     */
    private void parse(final BiConsumer<String, String> listener, final char[] text, int offset, int length, char separator) {
        this.text = text;
        this.offset = offset;
        this.length = length;
     ...
     * @param value
     */
    private void putParameter(final BiConsumer<String, String> listener, String name, String value) {
        if (nameDecoder != null) {
