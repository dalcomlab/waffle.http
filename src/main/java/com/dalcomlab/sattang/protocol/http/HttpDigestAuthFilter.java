 ...
 */
public class HttpDigestAuthFilter extends HttpAuthFilter {
    ...
    public boolean filter(HttpRequest request) throws IOException {
        ...
        if (auth == null) {
            ...
            response.addHeader(HttpHeader.WWW_AUTHENTICATE, "Digest realm=\"Glamorous Cat Realm\", qop=\"auth,auth-int\", nonce=\"dcd98b7102dd2f0e8b11d0f600bfb0c093\", opaque=\"5ccc069c403ebaf9f0171e9517f40e41\"");
